...
def showCreate():
        try:
            ...
            if option==1:
                ...
                subprocess.call(['sudo python3 transit.py create '+config_file] ,shell = True)
            elif option==2:
                #create controller file
                config_file = input("Enter the controller configuration file name: ")
                subprocess.call(['sudo python3 controller.py create '+config_file], shell = True)
            elif option==3:
                #create PE file
                config_file = input("Enter the PE configuration file name: ")
                subprocess.call(['sudo python3 providerEdge.py create '+config_file], shell = True)
            elif option==4:
                #create CE file
                config_file = input("Enter the CE configuration file name: ")
                subprocess.call(['sudo python3 CustomerEdge.py create '+config_file], shell = True)
            elif option==5:
...
def showDelete():
        try:
            ...
            if option==1:
                #delete transit
                config_file = input("Enter the transit NS configuration file name: ")
                subprocess.call(['sudo python3 transit.py delete '+config_file] ,shell = True)
            elif option==2:
                #delete Controller file
                config_file = input("Enter the controller configuration file name: ")
                subprocess.call(['sudo python3 controller.py delete '+config_file], shell = True)
            elif option==3:
                #delete PE file
                config_file = input("Enter the PE configuration file name: ")
                subprocess.call(['sudo python3 providerEdge.py delete '+config_file], shell = True)
            elif option==4:
                #delete CE file
                config_file = input("Enter the CE configuration file name: ")
                subprocess.call(['sudo python3 CustomerEdge.py delete '+config_file], shell = True)
            elif option==5:
